...
export const PROFILE: Profile = {
  ...
  tagline:
    "Frontend-разработчик с 8-летним опытом. Создаю продуманные и быстрые интерфейсы на React и TypeScript. Строю архитектуру, оптимизирую процессы и довожу продукты до результата.",
  location: "Cyprus",
